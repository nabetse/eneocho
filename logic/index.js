...
const makePerCubeSizeDataEntry = cubeSize => {
  //console.log('El makePerCubeSizeDataEntry PER_CUBE_SIZE_DATA crea')
  //console.log('moveIdsToMoves :')
  const moveIdsToMoves = makeMoveIdsToMoves(cubeSize)
  //console.log(moveIdsToMoves)
  //console.log('moves :')
  const moves = Array.from(moveIdsToMoves.values())
  //console.log(moves)
  //console.log('y solvedCube:')
...
export const getSolvedCube = cubeSize => {
  //console.log('getSolvedCube corre PER_CUBE_SIZE_DATA')
  const perCubeSizeData = PER_CUBE_SIZE_DATA.get(cubeSize)
  //console.log('y retorna PER_CUBE_SIZE_DATA.solvedCube')
  //console.log(perCubeSizeData.solvedCube)
...
export const getRandomMove = cubeSize => {
  const perCubeSizeData = PER_CUBE_SIZE_DATA.get(cubeSize)
  ////console.log( 'Desde funcion getRandomMove:' )
  ////console.log( perCubeSizeData ) // esto va de o 0 a 26
  const randomIndex = Math.floor(Math.random() * perCubeSizeData.moves.length)
  return perCubeSizeData.moves[randomIndex]
}

export const getMovimiento = cual => {
  const perCubeSizeData = PER_CUBE_SIZE_DATA.get(3)
  ////console.log( 'Desde funcion getRandomMove:' )
  ////console.log( perCubeSizeData ) // esto va de o 0 a 26
  //const randomIndex = Math.floor(Math.random() * perCubeSizeData.moves.length)
  return perCubeSizeData.moves[cual]
}
